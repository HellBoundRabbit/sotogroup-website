...
def add_job():
    ...
    try:
        ...
        try:
            ...
            # Demo mode - basic parsing with confidence scores
            parsed_data = {
                ...
                'confidence_scores': {
                    'collection_address': 60,
                    'delivery_address': 60,
                    'price': 80,
                    'postcode_collection': 70,
                    'postcode_delivery': 70,
                    'vehicle_details': 50,
                    'contact_info': 50,
                    'notes': 90
                },
                'overall_confidence': 66.25,
                'accuracy_rating': 'fair',
                'parsing_quality': 'demo',
                'missing_fields': [],
                'uncertain_fields': ['collection_address', 'delivery_address', 'vehicle_details', 'contact_info']
            }
